...
export const PROJECTS: Project[] = [
    {
        ...
        githubUrl: '#',
        liveUrl: '#',
        infoDesign: 'newspaper', catalogId: 'PROJ-01', infoCategory: 'OPEN-SOURCE ARCHITECTURE', formatLabel: 'COLLABORATIVE PLATFORM',
    ...
    },
    {
        ...
        githubUrl: '#',
        liveUrl: '#',
        infoDesign: 'newspaper', catalogId: 'PROJ-03', infoCategory: 'TELEMETRY ANALYTICS', formatLabel: 'MISSION CONTROL SOFTWARE',
    ...
    },
    {
        ...
        githubUrl: '#',
        liveUrl: '#',
        infoDesign: 'newspaper', catalogId: 'PROJ-04', infoCategory: 'WEB3 MARKETPLACE', formatLabel: 'DECENTRALIZED COMMERCE',
    ...
    },
    {
        ...
        githubUrl: '#',
        liveUrl: '#',
        infoDesign: 'newspaper', catalogId: 'PROJ-05', infoCategory: 'CREATIVE AI TOOLING', formatLabel: 'PIXEL ART STUDIO',
