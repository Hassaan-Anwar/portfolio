...
export const PROJECTS: Project[] = [
    {
        ...
        githubUrl: '#',
        liveUrl: '#',
        infoDesign: 'studio-master-sheet', catalogId: 'PROJ-01', infoCategory: 'OPEN-SOURCE ARCHITECTURE', formatLabel: 'COLLABORATIVE PLATFORM',
    ...
    },
    {
        ...
        githubUrl: '#',
        liveUrl: '#',
        infoDesign: 'studio-master-sheet', catalogId: 'PROJ-02', infoCategory: 'MUSIC DISCOVERY', formatLabel: 'AI AUDIO EXPERIENCE',
    ...
    },
    {
        ...
        githubUrl: '#',
        liveUrl: '#',
        infoDesign: 'studio-master-sheet', catalogId: 'PROJ-03', infoCategory: 'TELEMETRY ANALYTICS', formatLabel: 'MISSION CONTROL SOFTWARE',
    ...
    },
    {
        ...
        githubUrl: '#',
        liveUrl: '#',
        infoDesign: 'studio-master-sheet', catalogId: 'PROJ-04', infoCategory: 'WEB3 MARKETPLACE', formatLabel: 'DECENTRALIZED COMMERCE',
    ...
    },
    {
        ...
        githubUrl: '#',
        liveUrl: '#',
        infoDesign: 'studio-master-sheet', catalogId: 'PROJ-05', infoCategory: 'CREATIVE AI TOOLING', formatLabel: 'PIXEL ART STUDIO',
